...
export function StopReviewCard({
  ...
  return (
    <motion.aside
      ...
      className="absolute bottom-8 left-1/2 z-20 w-[min(92vw,34rem)] -translate-x-1/2 rounded-2xl border border-white/20 bg-slate-900/75 p-5 shadow-[0_20px_60px_rgba(2,6,23,0.65)] backdrop-blur-md md:left-8 md:translate-x-0"
    >
      <p className="text-xs uppercase tracking-[0.22em] text-sky-300/90">
      ...
      <button
        ...
        className="mt-5 w-full rounded-lg bg-gradient-to-r from-sky-500 to-violet-500 px-4 py-2.5 text-sm font-medium text-white transition hover:brightness-110 sm:w-auto"
      >
